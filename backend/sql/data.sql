...
INSERT INTO listings(listing, owner, category) VALUES ('{"name": "toyota motorcycle", "price": "$420.00", "images": []}', (SELECT id FROM people LIMIT 1), (SELECT id FROM categories WHERE category->>'name' = 'vehicles'));
